...
function draw(){
  ...
  if(gameState == 'Level1'){
    ...
    if(player1.isTouching(box)){
      ...
      player1.visible=false;
      gameState = 'Level1Ques';
    }
  }
  if(gameState == 'Level1Ques'){
    ...
    else if(mousePressedOver(option12)){
      bgIMG=bgreset
      GroundGroup.setVisibleEach(false)
      option12.visible=false
      option11.visible=false
  ...
  if(gameState == 'Level2'){
    ...
    console.log(score)
    if(flag == 'Level2Started' && heart1.visible == false && heart2.visible == false && heart3.visible==false){
      bgIMG=bgreset;
      level2Group.setVisibleEach(false);
      wallsGroup.setVisibleEach(false);
    }
    ...
    if(flag == 'Level2Started' && coin1.visible=== false && coin2.visible=== false &&
      ...
      gameState = 'Level2Ques'
    }
  }
  if(gameState == 'Level2Ques'){
